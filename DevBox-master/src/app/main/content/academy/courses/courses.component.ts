  ...
  this.demoSteps = [
    {
      ...
      'content': '<h1>Step 1 - Introduction</h1>' +
        ...
        '<br><br>' +
        'il s’agit donc d’un ensemble de logiciels qui sert d’interface entre le materiel (les' +
        ' <b>SDK</b> tools:' +
        '<br><br>' +
        '<code>gradle</code>' +
        '<br><br>' +
    ...
    {
      'title': 'Création d’un projet et d’une application “Hello World"',
      'content': '<h1>Step 2 - Get the sample code</h1>' +
        ...
        '<br><br>' +
        '<code>Minimum required SDK :</code>' +
        '<br><br>' +
        'To verify that the CLI has been installed correctly, open a console and run:' +
        '<br><br>' +
        '<code>ng version</code>' +
